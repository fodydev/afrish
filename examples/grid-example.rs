...
fn main() {
    ...
    content.grid().sticky("nsew").layout();
    frame.grid().column_span(3).row_span(2).sticky("nsew").layout();
    name_label.grid().row(0).column(3).column_span(2).sticky("nw").padx(5).layout();
    name.grid().row(1).column(3).column_span(2).sticky("new").pady(5).padx(5).layout();
