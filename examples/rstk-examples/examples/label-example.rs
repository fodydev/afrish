...
fn main() {
    ...
    let label_4 = rish::make_label(&root);
    label_4.image(&image);
    label_4.text("Tcl Logo");

    let label_5 = rish::make_label(&root);
    label_5.image(&image);
    label_5.text("Tcl Logo");

    let label_6 = rish::make_label(&root);
    label_6.image(&image);
    ...
    label_4.compound(rish::Compound::Bottom);
    label_5.compound(rish::Compound::Centre);
    label_6.compound(rish::Compound::Top);
    ...
    label_7.grid().row(2).column(0).column_span(3).sticky(rish::Sticky::NESW).layout();
