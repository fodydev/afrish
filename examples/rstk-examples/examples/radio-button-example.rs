...
fn main() {
    ...
    let button_1 = rish::make_radio_button(&root, "colours", "red");
    button_1.text("Red");
    let button_2 = rish::make_radio_button(&root, "colours", "green");
    button_2.text("Green");
    let button_3 = rish::make_radio_button(&root, "colours", "blue");
    button_3.text("Blue");
